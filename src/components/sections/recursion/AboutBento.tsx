...
export default function RecursionAboutBento() {
    return (
    ...
    return (
        ...
        >
            ...
            <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-black border-white/[0.1] border p-4 flex flex-col items-center justify-center">
                ...
                />
                <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
                    Jenga ? Idk that, play Django with me.
                </p>
        ...
        >
            ...
            >
                ...
                <p className="text-xs text-neutral-500">
                    You heard about the Recursion 6.0 Prizepool ? 
                </p>
            </motion.div>
            <motion.div
                variants={variantsSecond}
            ...
            >
                <p className="text-xs text-neutral-500">OFCOURSE, it's CRAZEH.</p>
                <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
            </motion.div>
        </motion.div>
    )
...
const items = [
    {
        title: "Event Date",
        description: <span className="text-sm">21st March to 22nd March 2025</span>,
        header: <SkeletonOne />,
    ...
    {
        title: "Team Size", 
        description: <span className="text-sm">2 or 4 members per team</span>,
        header: <SkeletonTwo />,
        className: "md:col-span-1",
    ...
    {
        title: "Registration",
        description: <span className="text-sm">Free registrations for all participants</span>,
        header: <SkeletonThree />,
        className: "md:col-span-1",
        icon: <IconSignature className="h-4 w-4 text-neutral-500" />,
    },
    {
        title: "Participation as Team",
        description: (
            <span className="text-sm">
                Participation is absolutely free, however we request you not to back out after getting shortlisted
            </span>
        ),
        header: <SkeletonFour />,
    ...
    {
        title: "Prizes",
        description: <span className="text-sm">Prizes worth Rs. 200k+, Swags, vouchers and lot more!</span>,
        header: <SkeletonFive />,
        className: "md:col-span-1",
