...
interface SlideData {
  title: string;
  button?: string; // Made button optional
  src: string;
}
        ...
        >
          ...
          {button && (
            <div className="flex justify-center">
              <button className="mt-6 px-4 py-2 w-fit mx-auto sm:text-sm text-white bg-neutral-800 h-12 border border-neutral-700 text-xs flex justify-center items-center rounded-2xl hover:bg-neutral-700 transition duration-200">
                {button}
              </button>
            </div>
          )}
